            ...
            <table class="min-w-full text-sm text-gray-600">
                ...
                <tbody class="divide-y divide-gray-200">
                    <tr v-for="tl in transactionList.data" :key="tl.id" class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 font-medium text-gray-800"><button class="px-2 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700"
                                @click="openModalCustomer(tl.customer)">{{ tl.customer.name }}</button></td>
                        <td class="px-4 py-3"><button @click="openModalCar(tl.car)" class="px-2 py-1 rounded-full text-xs font-semibold bg-blue-100 text-blue-700">{{ tl.car.model }}</button></td>
