  ...
  <table class="min-w-full bg-white text-sm">
    ...
    <tbody class="divide-y divide-gray-200">
      ...
      >
        ...
        <td class="px-4 py-3">
          <img
            :src="car.image ? `/storage/car/${car.image}` : '/storage/car/default-car.jpg'"
            alt="Car"
...
<div class="mt-6 flex justify-end items-center space-x-1">
  ...
  <!-- Page Numbers -->
  <button
    v-for="link in cars.links.filter((l) => !isNaN(l.label))"
            ...
            >
                ...
                <form @submit.prevent="storeCar" class="space-y-4">
                    ...
                    <div>
                        ...
                        <!-- Progress upload -->
                        <progress
                            v-if="formStore.progress"
                            :value="formStore.progress.percentage"
                            max="100"
                            class="w-full mt-2"
                        >
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.brand"
                                class="text-red-700 italic"
                                >{{ formStore.errors.brand }}</span
                            >
                            <input
                                type="text"
                                v-model="formStore.brand"
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.model"
                                class="text-red-700 italic"
                                >{{ formStore.errors.model }}</span
                            >
                            <input
                                type="text"
                                v-model="formStore.model"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.plate_number"
                                class="text-red-700 italic"
                                >{{ formStore.errors.plate_number }}</span
                            >
                            <input
                                type="text"
                                v-model="formStore.plate_number"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.color"
                                class="text-red-700 italic"
                                >{{ formStore.errors.color }}</span
                            >
                            <input
                                type="text"
                                v-model="formStore.color"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.year"
                                class="text-red-700 italic"
                                >{{ formStore.errors.year }}</span
                            >
                            <input
                                type="number"
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formStore.errors.price_per_day"
                                class="text-red-700 italic"
                                >{{ formStore.errors.price_per_day }}</span
                            >
                            <input
                                type="number"
                                v-model="formStore.price_per_day"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        >
                        <span
                            v-if="formStore.errors.status"
                            class="text-red-700 italic"
                            >{{ formStore.errors.status }}</span
                        >
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input
                                    type="radio"
                                    v-model="formStore.status"
                                    value="available"
                                />
                                <span>Tersedia</span>
                            </label>
                ...
                <form @submit.prevent="updateCar" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="file"
                            accept="image/*"
                            @change="handleImageUploadU"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                        />
                        <input type="hidden" v-model="formUpdate.old_image" />
                        <!-- Progress upload -->
                        <progress
                            v-if="formUpdate.progress"
                            :value="formUpdate.progress.percentage"
                            max="100"
                            class="w-full mt-2"
                        >
                        ...
                        <div class="mt-3">
                            ...
                            <img
                                v-else-if="selectedCar && selectedCar.image"
                                :src="`/storage/car/${selectedCar.image}`"
                                alt="Gambar Lama"
                                class="w-32 h-24 object-cover rounded border"
                            />
                            ...
                            <img
                                v-else
                                :src="'/storage/car/default-car.jpg'"
                                alt="Gambar Lama"
                                class="w-32 h-24 object-cover rounded border"
                            />
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.brand"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.brand }}</span
                            >
                            <input
                                type="text"
                                v-model="formUpdate.brand"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.model"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.model }}</span
                            >
                            <input
                                type="text"
                                v-model="formUpdate.model"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.plate_number"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.plate_number }}</span
                            >
                            <input
                                type="text"
                                v-model="formUpdate.plate_number"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.color"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.color }}</span
                            >
                            <input
                                type="text"
                                v-model="formUpdate.color"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.year"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.year }}</span
                            >
                            <input
                                type="number"
                                v-model="formUpdate.year"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            >
                            <span
                                v-if="formUpdate.errors.price_per_day"
                                class="text-red-700 italic"
                                >{{ formUpdate.errors.price_per_day }}</span
                            >
                            <input
                                type="number"
                                v-model="formUpdate.price_per_day"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring focus:ring-blue-200"
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        >
                        <span
                            v-if="formUpdate.errors.status"
                            class="text-red-700 italic"
                            >{{ formUpdate.errors.status }}</span
                        >
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input
